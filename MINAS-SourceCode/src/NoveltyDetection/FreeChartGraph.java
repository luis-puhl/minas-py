...
public class FreeChartGraph {
    ...
    // ***********************************************
    // *********************************************************************************************
    public static XYDataset createDataSetXY(List<Float> a, List<Float> b, List<Float> c, List<Float> d,
    ...
    // **************************************
    // *********************************************************************************************
    public void createGraph(List<Float> med1, List<Float> med2, List<Float> med3, List<Float> values_Timestamp,
            List<Integer> values_Nov, List<Integer> values_Ext, int flagTipoAv) throws IOException {

        XYDataset dataXY = createDataSetXY(med1, med2, med3, values_Timestamp, flagTipoAv);
        graph = ChartFactory.createXYLineChart("", "Timestamp (in thousands)", "Evaluation Measure Value", dataXY,
